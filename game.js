...
function atualizaMostrador() {
  ...
  if (playTime == player1) {
    ...
    player.setAttribute('src', 'img/x.jpg.png')
  } else {
    var player = document.querySelectorAll('div#mostrador img')[0]
    player.setAttribute('src', 'img/circulo.jpg')
  }
}
  ...
  for (var i = 0; i < espaços.length; i++) {
    espaços[i].addEventListener('click', function () {
      ...
      if (this.getElementsByTagName('img').length == 0) {
        if (playTime == player1) {
          this.innerHTML = "<img src='img/x.jpg.png'  height='50'>"
          this.setAttribute('jogada', player1)
          playTime = player2
        } else {
          this.innerHTML = "<img src='img/circulo.jpg' height= '50'>"
